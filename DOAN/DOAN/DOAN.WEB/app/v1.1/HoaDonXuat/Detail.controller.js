sap.ui.define([
    ...
    'use strict';
    return Controller.extend('app.HoaDonXuat.Detail', {
        ...
        onInit: function () {
            ...
            this.bus.subscribe('HoaDonXuatChannel', 'loadDetailPage', this.loadDetailPage, this);
            this.bus.subscribe('HoaDonXuatChannel', 'onCloseHoaDonXuatEdit', this.onCloseHoaDonXuatEdit, this);
            this.bus.subscribe('HoaDonXuatChannel', 'loadThucDonData', this.loadThucDonData, this);
            this.bus.subscribe('HoaDonXuatChannel', 'onCloseThucDonHoaDonXuatAdd', this.onCloseThucDonHoaDonXuatAdd, this);
            this.bus.subscribe('HoaDonXuatChannel', 'onCloseThucDonHoaDonXuatEdit', this.onCloseThucDonHoaDonXuatEdit, this);
            this.bus.subscribe('HoaDonXuatChannel', 'onCloseThucDonHoaDonXuatDetail', this.onCloseThucDonHoaDonXuatDetail, this);
            this.bus.subscribe('HoaDonXuatChannel', 'switchToThucDonViewPage', this.switchToThucDonViewPage, this);
        ...
        loadDetailPage: function (oChannel, oEvent, oData) {
            ...
            if (oData && oData.Id) {
                ...
                Connector.getFromApi(sdConfig.adminApiEndpoint + 'HoaDonXuat/' + root.mainId, {
        ...
        loadChiTiet: function () {
            const root = this;
            Connector.getFromApi(sdConfig.adminApiEndpoint + 'ChitietPhieuXuat/phieuXuat/' + root.mainId, {
                fnProcessData: function (data) {
                    if (data) {
            ...
            MessageBox.show('Bạn chắc chắn muốn xóa ?', {
                ...
                onClose: function (oAction) {
                    if (oAction == MessageBox.Action.DELETE) {
                        Connector.deleteToApi(sdConfig.adminApiEndpoint + 'HoaDonXuat/' + root.mainId, {
                            fnSuccess: function (data) {
                                root.bus.publish("HoaDonXuatChannel", "onCloseHoaDonXuatView");
                                root.bus.publish("HoaDonXuatChannel.Detail", "reLoadData");
            ...
            if (this.mainId) {
                ...
                if (!this._imgEdit) {
                    Fragment.load({
                        ...
                        root._imgEdit = frag;
                        root._imgEdit.open();
                        root.bus.publish('HoaDonXuatChannel', 'loadEditPage', { Id: root.mainId, title: root.title });
                    });
                }
                else {
                    root._imgEdit.open();
        ...
        onTabSelectionChange: function (oEvent) {
            ...
            if (key === 'HoaDonXuatTab') this.loadDetailPage();
        ...
        loadThucDonData: function () {
            if (this.mainId) {
                ...
                Connector.getFromApi(sdConfig.adminApiEndpoint + 'thucdon/HoaDonXuat/' + this.mainId, {
                    fnProcessData: function (data) {
        ...
        addThucDon: function () {
            ...
            if (!this._ThucDonThucDonAdd) {
                Fragment.load({
                    id: root.getView().getId(),
                    name: "app.HoaDonXuat.ThucDon.Add",
                    type: "XML",
                    controller: this
                }).then(function (frag) {
                    root._ThucDonThucDonAdd = frag;
                    root._ThucDonThucDonAdd.open();
                    root.bus.publish('HoaDonXuatChannel', 'loadAddThucDonPage', { Id: root.mainId });
                });
            }
            else {
                root._ThucDonThucDonAdd.open();
                this.bus.publish('HoaDonXuatChannel', 'loadAddThucDonPage', { Id: root.mainId });
            }
        },
        onCloseThucDonHoaDonXuatAdd: function () {
            if (this._ThucDonThucDonAdd)
        ...
        onRowViewThucDon: function (oEvent) {
            ...
            this.bus.publish('HoaDonXuatChannel', 'switchToThucDonViewPage', { Id: selectedId.id, IdMonAn: selectedId.idMonAn });
        },
        ...
        switchToThucDonViewPage: function (oChannel, oEvent, oData) {
            if (oData.Id) {
                ...
                if (!this._ThucDonThucDonView) {
                    Fragment.load({
                        id: root.getView().getId(),
                        name: "app.HoaDonXuat.ThucDon.Detail",
                        type: "XML",
                        controller: this
                    }).then(function (frag) {
                        root._ThucDonThucDonView = frag;
                        root._ThucDonThucDonView.open();
                        root.bus.publish('HoaDonXuatChannel', 'loadDetailThucDonPage', { Id: oData.Id, IdMonAn: oData.IdMonAn });
                    });
                }
                else {
                    root._ThucDonThucDonView.open();
                    this.bus.publish('HoaDonXuatChannel', 'loadDetailThucDonPage', { Id: oData.Id, IdMonAn: oData.IdMonAn });
                }
            }
        },
        onCloseThucDonHoaDonXuatDetail: function () {
            if (this._ThucDonThucDonView)
        ...
        onRowEditThucDon: function (oEvent) {
            ...
            if (selectedId) {
                ...
                if (!this._ThucDonThucDonEdit) {
                    Fragment.load({
                        id: root.getView().getId(),
                        name: "app.HoaDonXuat.ThucDon.Edit",
                        type: "XML",
                        controller: this
                    }).then(function (frag) {
                        root._ThucDonThucDonEdit = frag;
                        root._ThucDonThucDonEdit.open();
                        root.bus.publish('HoaDonXuatChannel', 'loadEditThucDonPage', { Id: selectedId.id, IdMonAn: selectedId.idMonAn });
                    });
                }
                else {
                    root._ThucDonThucDonEdit.open();
                    this.bus.publish('HoaDonXuatChannel', 'loadEditThucDonPage', { Id: selectedId.id, IdMonAn: selectedId.idMonAn });
                }
            }
        },
        onCloseThucDonHoaDonXuatEdit: function () {
            if (this._ThucDonThucDonEdit)
