sap.ui.define([
    ...
    'use strict';
    return Controller.extend('app.NhanVien.Add', {
        ...
        closeArea: function () {
            this.clearForm();
            this.bus.publish('NhanVienChannel', 'onCloseNhanVienAdd');
        },
        ...
        save: function () {
            ...
            if (this.validateForm()) {
                ...
                paras.luongCB = Number(paras.luongCoBan);
                Connector.postToApi(sdConfig.adminApiEndpoint + 'NhanVien', {
                    oParameters: paras,
                    fnSuccess: function () {
