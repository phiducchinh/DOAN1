...
namespace DOAN.API.Migrations
{
    ...
    [Migration("20221006014642_first")]
    partial class first
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("DOAN.API.ViewModel.ChiTietPhieuNhap", b =>
                {
                    ...
                    b.Property<double?>("soLuongConLai")
                        .HasColumnType("float");
            ...
            modelBuilder.Entity("DOAN.API.ViewModel.ChiTietPhieuXuat", b =>
                {
                    b.HasOne("DOAN.API.ViewModel.ChiTietPhieuNhap", "chiTietPhieuNhap")
                        .WithMany()
                        .HasForeignKey("idChiTietNhap");
